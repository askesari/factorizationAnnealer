"""
This module executes the integer factorisation program for column-based method on dwave system.
...
def main():
    ...
    feas_sols = get_solns_quantum(Q_dict, Q_offset, sampler=dwaveSampler, samples = 500, init_state=None)
